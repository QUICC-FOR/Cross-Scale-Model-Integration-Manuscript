...
All data, as well as all code required to repeat the analyses, have been uploaded as online supporting information in Appendix S3.
...
Appendix S1: Supporting information on using the code and data for example 1. \\
Appendix S2: Supporting information on using the code and data for example 2. \\
Appendix S3: Scripts and data required to reproduce the analyses.
