...
\begin{titlingpage}
	...
	\textbf{Abstract word count: } 295 %ABS_COUNT
	
	\textbf{Main text word count: } 5010 %WORD_COUNT %Target 5000
...
\noindent
\paragraph{Aim} 
Current interest in forecasting changes to species ranges have resulted in a wide range of approaches to species distribution models (SDMs).
...
\paragraph{Methods}
\rev{Our framework builds a metamodel that is constrained by the results of multiple sub-models and provides probabilistic estimates of species presence.
...
\paragraph{Results}
\rev{For both examples, the integrated models successfully included information from all data sources and substantially improved the characterization of uncertainty.
